...
The Python runtime calls this wrapper through a context HTTP adapter. The default implementation is still `MockContextHttpAdapter`; set `USE_CONTEXT_HTTP=1` to use `RealContextHttpAdapter`.
